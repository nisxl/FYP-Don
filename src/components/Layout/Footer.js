...
function Footer() {
  return (
    <section className="bg-[#FBEDCD] flex h-[265px]">
      <div className="flex flex-col mt-[80px] px-[70px] items-center border-2 border-black">
      ...
      <div className="flex items-center border-2 grow border-black justify-evenly">
        ...
        <div className="flex flex-col border-2 border-black gap-6">
